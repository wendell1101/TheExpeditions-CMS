...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-white" style="text-shadow: 1px 3px 5px #333;">@yield('page-title', 'Administration')</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; <span class="text-info">2020 The Expeditions</span></strong>
      All rights reserved.
